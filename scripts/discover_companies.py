...
from the clock: 6 providers x 16 cities x 10 roles is 960 slots, so a two-minute
cron runs for over a day before it repeats a question.
...
ROLES = [
    ...
    "Frontend Engineer", "Sales", "Marketing", "Designer", "DevOps Engineer",
    "Customer Success",
]

# The sixteen the directory has always covered, so this path reaches the same
# country the retired Go rotation did.
CITIES = [
...
def main():
    ...
    ap.add_argument("--pages", type=int, default=5,
                    help="SearXNG pages to walk (default 5; returns fall off after 4)")
